    ...
    <section className="about-me" id="about-me">
      ...
      <div className="about-me__container">
        <div className="about-me__description-container">
          ...
          И в процессе я сильно загорелся идеей овладеть навыками программирования. Вспомнил, как еще в студенчестве любил заниматься разработкой сайтов на конструкторах Wix и Tilda, и понял, 
