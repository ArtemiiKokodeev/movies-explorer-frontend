    ...
    <section class="about-me" id="about-me">
      ...
      <div className="about-me__container">
        <div className="about-me__description-container">
          ...
          "Строительство мостов, железных дорог и транспортных тоннелей". Последний курс я благодаря стипендии учился за рубежом, 
          в Словацком технологическом университете в г.Братислава. Также в тот год я прошел месячный языковой курс в Университете Глостершира 
          в г.Челтнем, UK, заняв первое место в {websites.headHunter} от компании HeadHunter ({websites.youTube}). 
          </p>
          ...
          технического заказчика на программе проектов компании IKEA. А с мая 2022 г. и по настоящее время развиваю в качестве менеджера продукта внутреннюю ERP систему 
          по управлению проектами в компании {websites.sminex}, ведущего столичного девелопера в сегменте элитной и премиум недвижимости.
          </p>
